...
import { hasPermission, hasAnyPermission } from '@tms/shared/utils/permissions';
import type { Role, PermissionResource, PermissionAction } from '@tms/shared/types/rbac';
